...
public: 
    ...
    : _data()
    {
        ...
        //LOGINFO("In the default constructor of Map!");
    }
    ...
    {
        static_assert(std::is_convertible<V, Ref*>::value, "Invalid Type for cocos2d::Map<K, V>!");
        //LOGINFO("In the constructor with capacity of Map!");
    ...
    {
        static_assert(std::is_convertible<V, Ref*>::value, "Invalid Type for cocos2d::Map<K, V>!");
        //LOGINFO("In the copy constructor of Map!");
        _data = other._data;
        addRefForAllObjects();
    }
    ...
    {
        static_assert(std::is_convertible<V, Ref*>::value, "Invalid Type for cocos2d::Map<K, V>!");
        //LOGINFO("In the move constructor of Map!");
    ...
    ~Map<K, V>()
    {
        //LOGINFO("In the destructor of Map!");
        clear();
    }
    ...
    {
        //ASSERT(position != _data.cend(), "Invalid iterator!");
    ...
    {
        if (this != &other) {
            //LOGINFO("In the copy assignment operator of Map!");
            clear();
            _data = other._data;
            addRefForAllObjects();
        }
    ...
    {
        if (this != &other) {
            //LOGINFO("In the move assignment operator of Map!");
            clear();
            _data = std::move(other._data);
        }
        return *this;
