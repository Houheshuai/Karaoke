#ifndef __ACTION_TILEDGRID_ACTION_H__
#define __ACTION_TILEDGRID_ACTION_H__

#include "Action/ActionGrid.h"
 ...
 */
class ShakyTiles3D : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(ShakyTiles3D);
};
...
*/
class ShatteredTiles3D : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(ShatteredTiles3D);
};
...
*/
class ShuffleTiles : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(ShuffleTiles);
};
 ...
 */
class FadeOutTRTiles : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(FadeOutTRTiles);
};
 ...
 */
class FadeOutBLTiles : public FadeOutTRTiles
{
public:
    /** 
    * @brief Create the action with the grid size and the duration.
...
private:
    DISALLOW_COPY_AND_ASSIGN(FadeOutBLTiles);
};
 ...
 */
class FadeOutUpTiles : public FadeOutTRTiles
{
public:
    /** 
    * @brief Create the action with the grid size and the duration.
...
private:
    DISALLOW_COPY_AND_ASSIGN(FadeOutUpTiles);
};
 ...
 */
class FadeOutDownTiles : public FadeOutUpTiles
{
public:
    /** 
    * @brief Create the action with the grid size and the duration.
...
private:
    DISALLOW_COPY_AND_ASSIGN(FadeOutDownTiles);
};
 ...
 */
class TurnOffTiles : public TiledGrid3DAction
{
public:
    /** 
    * @brief Create the action with the grid size and the duration.
...
private:
    DISALLOW_COPY_AND_ASSIGN(TurnOffTiles);
};
...
*/
class WavesTiles3D : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(WavesTiles3D);
};
...
*/
class JumpTiles3D : public TiledGrid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(JumpTiles3D);
};
...
*/
class SplitRows : public TiledGrid3DAction
{
public :
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(SplitRows);
};
...
*/
class SplitCols : public TiledGrid3DAction
{
public:
...
private:
    DISALLOW_COPY_AND_ASSIGN(SplitCols);
};


/**
@brief OrbitGrid3D action.
*/
class OrbitGrid3D : public TiledGrid3DAction
{
public:
    
    static OrbitGrid3D* create(float duration, const Size& gridSize, int direction = -1);

    // Overrides
	virtual OrbitGrid3D* clone() const override;
...
public:
    ...
    bool initWithDuration(float duration, const Size& gridSize, int direction);
...
protected:
	...
	int	_direction;
private:
    DISALLOW_COPY_AND_ASSIGN(OrbitGrid3D);
};

#endif // __ACTION_TILEDGRID_ACTION_H__
