#ifndef __ACTION_GRID3D_ACTION_H__
#define __ACTION_GRID3D_ACTION_H__
...
*/
class Waves3D : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(Waves3D);
};
...
*/
class FlipX3D : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(FlipX3D);
};
...
public:
    ...
    virtual ~FlipY3D() {}
private:
    DISALLOW_COPY_AND_ASSIGN(FlipY3D);
};
...
*/
class Lens3D : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(Lens3D);
};
...
*/
class Ripple3D : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(Ripple3D);
};
...
*/
class Shaky3D : public Grid3DAction
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(Shaky3D);
};
...
*/
class Liquid : public Grid3DAction
{
public:
    /**
...
*/
class Waves : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(Waves);
};
...
*/
class Twirl : public Grid3DAction
{
public:
    /**
...
private:
    DISALLOW_COPY_AND_ASSIGN(Twirl);
};

#endif // __ACTION_GRID3D_ACTION_H__
