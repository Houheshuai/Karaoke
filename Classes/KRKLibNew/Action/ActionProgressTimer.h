#ifndef __ACTION_PROGRESS_TIMER_H__
#define __ACTION_PROGRESS_TIMER_H__
...
@since v0.99.1
*/
class ProgressTo : public ActionInterval
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(ProgressTo);
};
...
@since v0.99.1
*/
class ProgressFromTo : public ActionInterval
{
public:
    /** 
...
private:
    DISALLOW_COPY_AND_ASSIGN(ProgressFromTo);
};

#endif // __ACTION_PROGRESS_TIMER_H__
