#ifndef __INSTANT_ACTION_H__
#define __INSTANT_ACTION_H__
...
/** @class FlipX
* @brief Flips the Node horizontally.
* @since v0.99.0
*/
...
public:
    /** Create the action.
     *
     * @param x Flips the Node horizontally if true.
...
/** @class FlipY
* @brief Flips the Node vertically.
* @since v0.99.0
*/
...
public:
    /** Create the action.
     *
     * @param y Flips the Node vertically if true.
