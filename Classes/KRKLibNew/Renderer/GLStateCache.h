 ...
 * @since v2.0.0
 */
extern void invalidateStateCache(void);
 ...
 * @since v2.0.0
 */
extern void blendResetToCache(void);

/** 
 * Sets the projection matrix as dirty.
 * @since v2.0.0
 */
extern void setProjectionMatrixDirty(void);
 ...
 * @since v2.0.0
 */
extern void enableVertexAttribs(unsigned int flags);
 ...
 * @since v2.0.0
 */
extern void bindTexture2D(GLuint textureId);
 ...
 * @since v2.1.0
 */
extern void bindTexture2DN(GLuint textureUnit, GLuint textureId);

/** If the texture is not already bound to a given unit, it binds it.
 * If CC_ENABLE_GL_STATE_CACHE is disabled, it will call glBindTexture() directly.
 * @since v3.6
 */
extern void bindTextureN(GLuint textureUnit, GLuint textureId, GLuint textureType = GL_TEXTURE_2D);
 ...
 * @since v2.0.0
 */
extern void deleteTexture(GLuint textureId);
 ...
 * @since v2.1.0
 */
extern void deleteTextureN(GLuint textureUnit, GLuint textureId);
