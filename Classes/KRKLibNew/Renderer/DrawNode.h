...
public:
    ...
    */
     ...
     * @js NA
     */
    virtual void onDraw(const Mat4 &transform, unsigned int flags);
    /**
     * @js NA
     */
    virtual void onDrawGLLine(const Mat4 &transform, unsigned int flags);
    /**
     * @js NA
     */
    virtual void onDrawGLPoint(const Mat4 &transform, unsigned int flags);
