#ifndef __SPRITE_AUTO_NODE_SPRITE_H__
#define __SPRITE_AUTO_NODE_SPRITE_H__
...
#if SPRITEBATCHNODE_RENDER_SUBPIXEL
...
/**
 * SpriteAuto is a 2d image ( http://en.wikipedia.org/wiki/Sprite_(computer_graphics) ).
 *
 * SpriteAuto can be created with an image, or with a sub-rectangle of an image.
 *
 * To optimize the SpriteAuto rendering, please follow the following best practices:
 ...
 *  - Sprites can only have other Sprites (or subclasses of SpriteAuto) as children.
 *
 * The default anchorPoint in SpriteAuto is (0.5, 0.5).
 */
class SpriteAuto : public Node, public TextureProtocol
{
public:
     /** SpriteAuto invalid index on the SpriteBatchNode. */
     ...
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* create(const std::string& filename);
     ...
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* create(const PolygonInfo& info);
     ...
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* create(const std::string& filename, const Rect& rect);
     ...
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* createWithTexture(Texture2D *texture);
     ...
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* createWithTexture(Texture2D *texture, const Rect& rect, bool rotated=false);

	static SpriteAuto* createWithTexture(Texture2D *texture, float x, float y, float w, float h, bool rotated=false);
     ...
     * @return  An autoreleased sprite object.
     */
    //static SpriteAuto* createWithSpriteFrame(SpriteFrame *spriteFrame);
     ...
     *
     * @param   spriteFrameName A nullptr terminated string which indicates the sprite frame name.
     * @return  An autoreleased sprite object.
     */
    static SpriteAuto* createWithSpriteFrameName(const std::string& spriteFrameName);
   ...
   // virtual SpriteBatchNode* getBatchNode() const;
     ...
     * SpriteAuto *sprite = SpriteAuto::createWithTexture(batch->getTexture(), Rect(0, 0, 57, 57));
   ...
   // virtual void setBatchNode(SpriteBatchNode *spriteBatchNode);
    ...
    /**
     * Updates the texture rect of the SpriteAuto in points.
     *
	...
	virtual void setTextureRect(float x, float y, float width, float height);
    ...
    /** @{
     * Sets a new SpriteFrame to the SpriteAuto.
     */
     ...
     */
    //virtual void setDisplayFrameWithAnimationName(const std::string& animationName, long frameIndex);
    /// @}


    /// @{
    /// @name SpriteAuto Properties' setter/getters.

    /**
     * Whether or not the SpriteAuto needs to be updated in the Atlas.
     *
    ...
    /**
     * Makes the SpriteAuto to be updated in the Atlas.
     */
    ...
    /**
     * Returns the rect of the SpriteAuto in points.
     */
    ...
    /// @} End of SpriteAuto properties getter/setters
...
public :
	...
	void setTextureCoords(float x, float y, float width, float height);
...
private:
    DISALLOW_COPY_AND_ASSIGN(SpriteAuto);
};
