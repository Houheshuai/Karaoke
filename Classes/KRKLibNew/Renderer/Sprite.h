#ifndef __SPRITE_NODE_SPRITE_H__
#define __SPRITE_NODE_SPRITE_H__
...
public:
	...
	static Sprite* createWithTexture(Texture2D *texture, float x, float y, float w, float h, bool rotated=false);
...
public :
	...
	void setVertices(int pos, V3F_C4B_T2F _v);
	int getVerticesCount();
	V3F_C4B_T2F& getVertices(int pos);
...
#endif // __SPRITE_NODE_SPRITE_H__
