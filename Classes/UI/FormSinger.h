...
#ifndef _FORMSINGER_H_
#define _FORMSINGER_H_
...
namespace CEGUI
{
	...
	class M3D_ScrollBar;
	class M3D_Label;
	class FormSinger:public M3D_Form
	{
	public:

		FormSinger(const String& type, const String& name);
		virtual ~FormSinger(void);
