...
#ifndef _FORMSHORTMOVIE_H_
#define _FORMSHORTMOVIE_H_
...
class M3D_ScrollBar;
class M3D_Label;
class FormShortMovie:public M3D_Form
{
public:

	FormShortMovie(const String& type, const String& name);
	virtual ~FormShortMovie(void);
