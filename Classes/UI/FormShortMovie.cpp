...
const String FormShortMovie::EventNamespace("FormShortMovie");
const String FormShortMovie::WidgetTypeName("FormShortMovie");

//----------------------------------------------------------------------------//
FormShortMovie::FormShortMovie(const String& type, const String& name):
M3D_Form(type, name)
{
...
//----------------------------------------------------------------------------//
FormShortMovie::~FormShortMovie(void)
{

}

//----------------------------------------------------------------------------//
void FormShortMovie::constructWindow(WndRes_t *wndRes)
{
	M3D_Form::constructWindow(wndRes);
}

//----------------------------------------------------------------------------//
void FormShortMovie::destructWindow(void)
{
	M3D_Form::destructWindow();
}
	
//----------------------------------------------------------------------------//
void FormShortMovie::onShown(WindowEventArgs& e)
{
	M3D_Form::onShown(e);	
...
//----------------------------------------------------------------------------//
void FormShortMovie::onHidden(WindowEventArgs& e)
{
	M3D_Form::onHidden(e);
...
//----------------------------------------------------------------------------//
void FormShortMovie::onCreated(void)
{
	M3D_Form::onCreated();
		
	d_songlist = static_cast<M3D_PageListView *>(getChild(Res_FormShortMovie::SongList));
	d_songlist->setCircleEnable(false);
	d_songlist->setFocusBarResID(Res_FormShortMovie::FocusBar);
	d_songlist->onDataFill = CALLBACK_2(FormShortMovie::handleReloadData, this);
	d_songlist->onPageChange = CALLBACK_2(FormShortMovie::handlePageChange, this);
	d_songlist->setOnClickListener(CALLBACK_2(FormShortMovie::handleListClicked, this));
	d_songlist->setOnFocusChangeListener(CALLBACK_2(FormShortMovie::handleFocusChange, this));

	d_scrollbar = static_cast<M3D_ScrollBar*>(d_songlist->getChild(Res_FormShortMovie::ScrollBar));
	d_scrollbar->setPageValue(1);

	d_displaypic = static_cast<M3D_Label*>(getChild(Res_FormShortMovie::DisplayWindow)->getChild(Res_FormShortMovie::DisplayPic));
	d_searchlable = static_cast<M3D_Label*>(getChild(Res_FormShortMovie::T9));
	d_searchstr = static_cast<M3D_Label*>(d_searchlable->getChild(Res_FormShortMovie::T9string));
	d_singerName = static_cast<M3D_Label*>(getChild(Res_FormShortMovie::DisplayWindow)->getChild(Res_FormShortMovie::DisplayName));
	d_focusbar = static_cast<M3D_Label*>(getChild(Res_FormShortMovie::SongList)->getChild(Res_FormShortMovie::FocusBar));

	/*d_progcount = static_cast<M3D_Label*>(getChild(Res_FormShortMovie::ProgCount));
	d_count = static_cast<M3D_Label*>(d_progcount->getChild(Res_FormShortMovie::Count));*/
...
//----------------------------------------------------------------------------//
void FormShortMovie::onDestroyed(void)
{	
	M3D_Form::onDestroyed();
}

//----------------------------------------------------------------------------//
void FormShortMovie::onActivated(ActivationEventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMovie::onDeactivated(ActivationEventArgs& e)
{
	M3D_Form::onDeactivated(e);
}

//----------------------------------------------------------------------------//
void FormShortMovie::onActionStart(void)
{
	M3D_Form::onActionStart();
}

//----------------------------------------------------------------------------//
void FormShortMovie::onActionEnd(void)
{
	M3D_Form::onActionEnd();
}

//----------------------------------------------------------------------------//
void FormShortMovie::onTimeout(EventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMovie::onCharacter(KeyEventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMovie::initFormData(void)
{
...
void FormShortMovie::setFormData(int type, int subtype)
{
	switch(type)
	{
...
//----------------------------------------------------------------------------//
void FormShortMovie::setupBinding(bool firsttime)
{
	ReqPhoneDB* reqDb = (ReqPhoneDB*)ReqDB::getSingletonPtr();
	assert(reqDb != NULL);
...
//----------------------------------------------------------------------------//
void FormShortMovie::handleReloadData(M3D_Item *item, int position)
{
...
//----------------------------------------------------------------------------//
void FormShortMovie::handlePageChange(int currentPage, int totalPage)
{
...
//----------------------------------------------------------------------------//
void FormShortMovie::handleListClicked(M3D_Item *item, int position)
{		
		
}

void FormShortMovie::handleFocusChange(M3D_Item *item, int position)
{		
	refreshFocusInfo(true);
}

bool FormShortMovie::refreshFocusInfo(bool refreshSingerName)
{
...
void FormShortMovie::updateSinger(void)
{
	ReqPhoneDB* reqDb = (ReqPhoneDB *)(ReqPhoneDB::getSingletonPtr());
