...
#ifndef _FORMSHORTMP3_H_
#define _FORMSHORTMP3_H_
...
class M3D_ScrollBar;
class M3D_Label;
class FormShortMp3:public M3D_Form
{
public:

	FormShortMp3(const String& type, const String& name);
	virtual ~FormShortMp3(void);
