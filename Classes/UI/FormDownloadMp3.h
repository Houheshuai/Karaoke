...
#ifndef _FORMDOWNLOADMP3_H_
#define _FORMDOWNLOADMP3_H_
...
class M3D_ScrollBar;
class M3D_Label;
class FormDownloadMp3:public M3D_Form
{
public:

	FormDownloadMp3(const String& type, const String& name);
	virtual ~FormDownloadMp3(void);
