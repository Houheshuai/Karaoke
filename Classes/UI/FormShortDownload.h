...
#ifndef _FORMSHORTDOWNLOAD_H_
#define _FORMSHORTDOWNLOAD_H_
...
class FormShortDownload:public M3D_Form
{
public:

	FormShortDownload(const String& type, const String& name);
	virtual ~FormShortDownload(void);
