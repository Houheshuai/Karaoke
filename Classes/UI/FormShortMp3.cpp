...
const String FormShortMp3::EventNamespace("FormShortMp3");
const String FormShortMp3::WidgetTypeName("FormShortMp3");

//----------------------------------------------------------------------------//
FormShortMp3::FormShortMp3(const String& type, const String& name):
M3D_Form(type, name)
{
...
//----------------------------------------------------------------------------//
FormShortMp3::~FormShortMp3(void)
{

}

//----------------------------------------------------------------------------//
void FormShortMp3::constructWindow(WndRes_t *wndRes)
{
	M3D_Form::constructWindow(wndRes);
}

//----------------------------------------------------------------------------//
void FormShortMp3::destructWindow(void)
{
	M3D_Form::destructWindow();
}
	
//----------------------------------------------------------------------------//
void FormShortMp3::onShown(WindowEventArgs& e)
{
	M3D_Form::onShown(e);	
...
//----------------------------------------------------------------------------//
void FormShortMp3::onHidden(WindowEventArgs& e)
{
	M3D_Form::onHidden(e);
...
//----------------------------------------------------------------------------//
void FormShortMp3::onCreated(void)
{
	M3D_Form::onCreated();
		
	d_songlist = static_cast<M3D_PageListView *>(getChild(Res_FormShortMp3::SongList));
	d_songlist->setCircleEnable(false);
	d_songlist->setFocusBarResID(Res_FormShortMp3::FocusBar);
	d_songlist->onDataFill = CALLBACK_2(FormShortMp3::handleReloadData, this);
	d_songlist->onPageChange = CALLBACK_2(FormShortMp3::handlePageChange, this);
	d_songlist->setOnClickListener(CALLBACK_2(FormShortMp3::handleListClicked, this));
	d_songlist->setOnFocusChangeListener(CALLBACK_2(FormShortMp3::handleFocusChange, this));

	d_scrollbar = static_cast<M3D_ScrollBar*>(d_songlist->getChild(Res_FormShortMp3::ScrollBar));
	d_scrollbar->setPageValue(1);

	d_displaypic = static_cast<M3D_Label*>(getChild(Res_FormShortMp3::DisplayWindow)->getChild(Res_FormShortMp3::DisplayPic));
	d_searchlable = static_cast<M3D_Label*>(getChild(Res_FormShortMp3::T9));
	d_searchstr = static_cast<M3D_Label*>(d_searchlable->getChild(Res_FormShortMp3::T9string));
	d_singerName = static_cast<M3D_Label*>(getChild(Res_FormShortMp3::DisplayWindow)->getChild(Res_FormShortMp3::DisplayName));
	d_focusbar = static_cast<M3D_Label*>(getChild(Res_FormShortMp3::SongList)->getChild(Res_FormShortMp3::FocusBar));

	/*d_progcount = static_cast<M3D_Label*>(getChild(Res_FormShortMp3::ProgCount));
	d_count = static_cast<M3D_Label*>(d_progcount->getChild(Res_FormShortMp3::Count));*/
...
//----------------------------------------------------------------------------//
void FormShortMp3::onDestroyed(void)
{	
	M3D_Form::onDestroyed();
}

//----------------------------------------------------------------------------//
void FormShortMp3::onActivated(ActivationEventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMp3::onDeactivated(ActivationEventArgs& e)
{
	M3D_Form::onDeactivated(e);
}

//----------------------------------------------------------------------------//
void FormShortMp3::onActionStart(void)
{
	M3D_Form::onActionStart();
}

//----------------------------------------------------------------------------//
void FormShortMp3::onActionEnd(void)
{
	M3D_Form::onActionEnd();
}

//----------------------------------------------------------------------------//
void FormShortMp3::onTimeout(EventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMp3::onCharacter(KeyEventArgs& e)
{
...
//----------------------------------------------------------------------------//
void FormShortMp3::initFormData(void)
{
...
void FormShortMp3::setFormData(int type, int subtype)
{
	switch(type)
	{
...
//----------------------------------------------------------------------------//
void FormShortMp3::setupBinding(bool firsttime)
{
	ReqPhoneDB* reqDb = (ReqPhoneDB*)ReqDB::getSingletonPtr();
	assert(reqDb != NULL);
...
//----------------------------------------------------------------------------//
void FormShortMp3::handleReloadData(M3D_Item *item, int position)
{
...
//----------------------------------------------------------------------------//
void FormShortMp3::handlePageChange(int currentPage, int totalPage)
{
...
//----------------------------------------------------------------------------//
void FormShortMp3::handleListClicked(M3D_Item *item, int position)
{		
		
}

void FormShortMp3::handleFocusChange(M3D_Item *item, int position)
{		
	refreshFocusInfo(true);
}

bool FormShortMp3::refreshFocusInfo(bool refreshSingerName)
{
...
void FormShortMp3::updateSinger(void)
{
	ReqPhoneDB* reqDb = (ReqPhoneDB *)(ReqPhoneDB::getSingletonPtr());
