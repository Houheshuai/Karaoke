...
#ifndef _FORMSHORTSINGER_H_
#define _FORMSHORTSINGER_H_
...
class M3D_ScrollBar;
class M3D_Label;
class FormShortSinger:public M3D_Form
{
public:

	FormShortSinger(const String& type, const String& name);
	virtual ~FormShortSinger(void);
