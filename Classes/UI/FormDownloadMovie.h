...
#ifndef _FORMDOWNLOADMOVIE_H_
#define _FORMDOWNLOADMOVIE_H_
...
class M3D_ScrollBar;
class M3D_Label;
class FormDownloadMovie:public M3D_Form
{
public:

	FormDownloadMovie(const String& type, const String& name);
	virtual ~FormDownloadMovie(void);
