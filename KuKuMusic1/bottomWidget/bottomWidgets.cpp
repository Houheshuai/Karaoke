...
void bottomWidgets::init()
{
    ...
    m_mainslider->setStyleSheet("QSlider::groove:horizontal{border-radius:2px;height:3px;}" //水平滑块
                                "QSlider::sub-page:horizontal{background:rgb(255, 255, 160);}"
                                "QSlider::add-page:horizontal{background:rgb(200,200,209);}"
                                "QSlider::handle:horizontal{background:rgb(255, 255, 160);"
                                    "width:8px;border-radius:4px;margin:-3px 0px -3px 0px;}");
    ...
    m_labnowPlayname = new TextMovingWidget("酷酷音乐",this); //歌曲名，走马灯
    ...
    m_labposition = new QLabel("00:00/00:00",this); //歌曲时间
