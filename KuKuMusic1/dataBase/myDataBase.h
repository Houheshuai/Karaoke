...
public:
    ...
    static void addSong(const QString& listname,const QString&  songname,const QString&  url,
                        const QString&  duration); //添加歌曲
    ...
    static void renameList(const QString& oldname,const QString& newname);  //重命名列表
