...
//    m_btnlog = new myPushButton("登录",this);
//    m_btnregister = new myPushButton("注册",this);
//    m_btnlog->setFixedSize(26,24);
//    m_btnregister->setFixedSize(26,24);
//    m_btnlog->setStyleSheet("QPushButton{background:transparent;"
//                            "color:white;font-family:微软雅黑;font-size:12px;}");
//    m_btnregister->setStyleSheet("QPushButton{background:transparent;"
//                                 "color:white;font-family:微软雅黑;font-size:12px;}");
...
//    label2->adjustSize();
   ...
   // hyout1->addWidget(m_btnregister);
    ...
    myPushButton *m_btnreturn = new myPushButton(this); //返回按钮
    ...
    myPushButton *m_btnrefresh=new myPushButton(this);  //刷新按钮
   ...
   */
    ...
    //m_btnmobile=new myPushButton(this);     //手机按钮
    //m_btnsetting=new myPushButton(this);    //设置按钮
    m_btnskin=new myPushButton(this);       //皮肤按钮
   // m_btnmessage=new myPushButton(this);    //消息按钮
    //m_btnplaycard=new myPushButton(this);   //
    //m_btntool=new myPushButton(this);       //工具按钮
    //m_btngame=new myPushButton(this);       //游戏按钮
