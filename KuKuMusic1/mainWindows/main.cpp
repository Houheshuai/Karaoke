...
int main(int argc, char *argv[])
{
    ...
    if(!app.isRunning())
    {
        ...
        app.w = &w;
        w.show();
        w.setGeometry((QApplication::desktop()->width() - w.width())/2,
                      (QApplication::desktop()->height() - w.height())/2,1008,698);//居中显示
        w.middleWidget()->m_rightWid->listButtons().at(5)->click();
