...
//    m_btnCross=new myPushButton(this);  //添加到稍后播，暂时隐藏
...
//                              "QPushButton:pressed{border-image:url(:/image/middlewidget/btn_cross (3).png);}");
    //second
    m_btnLab = new myPushButton(this); //歌手图片按钮，点击显示主界面歌词
...
//    m_btnMore=new myPushButton(this);
    ...
    m_labduration->setFixedSize(80,14);
...
//                              "QPushButton:pressed{border:NULL;background-image:url(:/image/middlewidget/btn_mv (3).png);}");
    ...
    m_btnSongName->setStyleSheet("QPushButton{color:rgb(68,68,68);font-size:14px;font-family:微软雅黑;}"
                                 "QPushButton:hover{text-decoration: underline; color: rgb(100,176,250);}");

    m_btnAuthor->setStyleSheet("QPushButton{color:rgb(68,68,68);font-size:14px;font-family:微软雅黑;}"
                               "QPushButton:hover{text-decoration: underline; color: rgb(100,176,250);}");

    m_labduration->setStyleSheet("color:rgb(78,78,78);font-size:12px;font-family:微软雅黑;");
