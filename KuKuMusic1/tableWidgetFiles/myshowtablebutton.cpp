...
void myShowTableButton::init()
{
    ...
    m_lineEdit = new QLineEdit(this);   //新建列表输入名称
    m_lineEdit->setGeometry(16,5,250,30);
    m_lineEdit->setContextMenuPolicy(Qt::NoContextMenu);
    m_lineEdit->setStyleSheet("QLineEdit{border:4px solid rgb(40,80,150); font-family:微软雅黑}");
    ...
    m_btnmenu = new myPushButton(this); //列表菜单选项(鼠标右键列表出现的菜单)
    m_indicator = new QLabel(this);     //指示图标 >
