...
public:
    ...
    void setinitMyTableFinal(myTablePlayListFinal* f)
    {
        m_finalWidget = f;   //it must to be initialized
    }
    void setinitMiddleStackWidget0(middleLeftStackWidget0* p)
    {
        m_middleftStack0 = p;   //need to initialization
    }
    const QString getHoverDuration()
    {
        return m_text;
    }
