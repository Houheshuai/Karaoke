...
void myTableAddWidget::init()
{
   ...
   m_add->setStyleSheet("QPushButton{color: rgb(58,58,58); font-family:微软雅黑; text-decoration: underline;}");
   m_addFolder->setStyleSheet("QPushButton{color: rgb(58,58,58); font-family:微软雅黑; text-decoration: underline;}");
